...
//==============================================================================
const juce::String YetiReverbAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool YetiReverbAudioProcessor::acceptsMidi() const
{
...
bool YetiReverbAudioProcessor::producesMidi() const
{
...
bool YetiReverbAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double YetiReverbAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int YetiReverbAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int YetiReverbAudioProcessor::getCurrentProgram()
{
    return 0;
}

void YetiReverbAudioProcessor::setCurrentProgram (int index)
{
}

const juce::String YetiReverbAudioProcessor::getProgramName (int index)
{
    return {};
}

void YetiReverbAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void YetiReverbAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool YetiReverbAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void YetiReverbAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//==============================================================================
bool YetiReverbAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* YetiReverbAudioProcessor::createEditor()
{
    return new YetiReverbAudioProcessorEditor (*this);
}

//==============================================================================
void YetiReverbAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void YetiReverbAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new YetiReverbAudioProcessor();
}
